...
export const ar = {
  ...
  home: {
    ...
    live: "وجهتك الأولى للألعاب والاشتراكات الرقمية",
    heroLine1: "عالم الألعاب",
    heroLine2: "بلمسة ملكية.",
    heroText:
      "بكجات ستيم، ألعاب سوني، اشتراكات المشاهدة ومستلزمات PC — كل اللي يحتاجه القيمر في مكان واحد، ويوصلك خلال ثوانٍ من الدفع.",
    shopNow: "تسوّق الآن",
    howItWorks: "كيف يعمل؟",
    stats: [
      { k: "تسليم", v: "فوري" },
