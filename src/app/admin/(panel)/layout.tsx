...
export default async function AdminPanelLayout({ children }: { children: ReactNode }) {
  ...
  const [awaitingDelivery, money] = await Promise.all([prisma.order.count({ where: { status: "PAID" } }), getAdminMoney()]);
  ...
  return (
    <div className="min-h-screen w-full lg:flex">
      <AdminNav
        ...
        currency={{ selected: money.fx.currency, options: money.options }}
      />
